...
private:
    ...
    void about_menu();
    auto spout_out_manager() -> SpoutOutManager& { return project().spout_out_manager; }
    auto spout_out_manager() const -> SpoutOutManager const& { return project().spout_out_manager; }
