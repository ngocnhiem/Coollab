...
import { FaExchangeAlt, FaVideo, FaMusic, FaCode, FaWifi, FaKeyboard } from 'react-icons/fa';
...
export default function FeaturesList() {
  return (
    ...
    <div className={styles.buttonWrapper}>
        <a href="/Tutorials/Discovery/Intro"  className={styles.secondaryBtn}>See more</a>
      </div>
    </section>
  );
}
